...
## Example Ludwig et al., Figure 5 **Exclusionlist filtering**

```{r fig5exclusionlist,fig.width = 6, fig.height=4}
library(mitoClone2)
library(pheatmap)
...
LudwigFig7 <- mutationCallsFromExclusionlist(LudwigFig7.Counts,min.af=0.1, min.num.samples=3, universal.var.cells = 0.25 * length(LudwigFig7.Counts), binarize = 0.1)
